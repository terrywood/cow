...
public class AccountService {
    ...
    private static String FRIENDS ="5890067,1222100,4396318,761738,5827248,5544002,4954,5569850,94916,359874,335976,5302991,4034125,64193,5750720,4904532,3832417,6026528,6026380,6028641,6026400,5975300,5736249,3803325,5061951,5701284,12153,98077,4096,16236,111517,5835775,4890303,5802162,10100,565784,773183,131984,605166";
    /*guo jin*/
    ...
    @Scheduled(cron = "0 0/30 10-16 * * MON-FRI")
    ...
    public List<AccountDaily>  findByAccountID(Long aid)  {
        Pageable pageable = new PageRequest(0,10,Sort.Direction.DESC,"id");
        return accountDailyRepository.findByAccountID(aid,pageable);
    }
    public void updateAccount(String aid) throws IOException {
        ...
        data.setPosition(callback.getPosition());
